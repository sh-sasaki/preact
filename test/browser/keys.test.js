import { createElement, Component, createRoot } from 'preact';
...
describe('keys', () => {
	...
	it('should swap keyed children efficiently', () => {
		render(<List values={['a', 'b']} />);
		expect(scratch.textContent).to.equal('ab');

		clearLog();

		render(<List values={['b', 'a']} />);
